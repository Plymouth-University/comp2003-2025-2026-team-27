...
public partial class TempBorImport
{
    public int BorImportId { get; set; }
    ...
    public string? BorAddr1No { get; set; }

    public string? BorAddr2No { get; set; }

    public string? BorAddr3No { get; set; }

    public string? BorAddr4No { get; set; }

    public string? BorPostcode { get; set; }

    public string? BorLandlineTel { get; set; }
    ...
    public string? BorPicData { get; set; }

    public string? BorStatus { get; set; }

    public string? BorOper { get; set; }

    public string? LibGroupId { get; set; }

    public string? BorRegdate { get; set; }

    public string? BorStartMship { get; set; }
}
