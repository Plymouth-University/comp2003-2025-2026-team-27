...
public partial class Borrower
{
    ...
    public DateOnly? BorDobDt { get; set; }

    public DateOnly? BorDob { get; set; }

    public DateOnly? UserPwdDue { get; set; }

    public string? HashedBorPin { get; set; }

    public string? WondeId { get; set; }

    public string? ParentConsentRestricted { get; set; }

    public virtual ICollection<BorAnswer> BorAnswers { get; set; } = new List<BorAnswer>();

    public virtual ICollection<BorFriend> BorFriendBorNoFriendNavigations { get; set; } = new List<BorFriend>();

    public virtual ICollection<BorFriend> BorFriendBorNoNavigations { get; set; } = new List<BorFriend>();

    public virtual ICollection<BorGroupMsg> BorGroupMsgs { get; set; } = new List<BorGroupMsg>();
